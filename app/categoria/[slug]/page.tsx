          ...
          {productosPaginados.map((item: Producto) => (
            ...
            >
              <div className="relative overflow-hidden">
                ...
                />
                      <span className="absolute top-3 left-3 bg-red-500 text-white text-sm font-bold px-3 py-1.5 rounded-lg shadow-sm leading-tight text-center">
                Descuento
        <span className="block text-base">{item.descuento}</span>
      </span>
